...
s.dataTransfer.effectAllowed=v[0],s.dataTransfer.setData(t,p)}}f.addClass("dndDragging"),i(function(){f.addClass("dndDraggingSource")},0)
var D=s.pageX-f.offset().left,y=s.pageY-f.offset().top
if(s._dndHandle&&s.dataTransfer.setDragImage&&s.dataTransfer.setDragImage(f[0],D,y),e(c.dndDragstart)(l,{event:s}),c.dndCallback){var T=e(c.dndCallback)
o.callback=function(e){return T(l,e||{})}}s.stopPropagation()}),f.on("dragend",function(n){n=n.originalEvent||n,l.$apply(function(){var a=o.dropEffect
...
h.insertBefore(T,o?r:r.nextSibling)}}var i=n==t,D=u(e,i)
