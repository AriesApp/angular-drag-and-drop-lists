...
c.dataTransfer.effectAllowed=v[0],c.dataTransfer.setData(t,p)}}f.addClass("dndDragging"),i(function(){f.addClass("dndDraggingSource")},0)
var D=c.pageX-f.offset().left,y=c.pageY-f.offset().top
if(c._dndHandle&&c.dataTransfer.setDragImage&&c.dataTransfer.setDragImage(f[0],D,y),e(s.dndDragstart)(l,{event:c}),s.dndCallback){var T=e(s.dndCallback)
o.callback=function(e){return T(l,e||{})}}c.stopPropagation()}),f.on("dragend",function(n){n=n.originalEvent||n,l.$apply(function(){var a=o.dropEffect
